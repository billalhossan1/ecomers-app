...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    productList = (json['results'] as List?)?.map((v) => WishModel.fromJson(v)).toList();
    total = json['total'];
...
class WishModel {
  ...
  WishModel({this.sId, this.product, this.user, this.quantity, this.color, this.size, this.createdAt, this.updatedAt, this.iV});
